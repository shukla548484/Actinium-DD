-- Job catalog library — idempotent (enums may already exist from parallel schema work)

DO $$ BEGIN CREATE TYPE "JobCatalogDepartment" AS ENUM ('engine', 'deck', 'electrical', 'hull', 'safety', 'cargo', 'accommodation'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobCatalogWorkshop" AS ENUM ('machinery', 'pipe', 'steel', 'hull', 'paint', 'electrical', 'deck', 'safety', 'qa_qc'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobTemplateCategory" AS ENUM ('machinery_overhaul', 'inspection', 'survey', 'repair', 'testing', 'cleaning', 'documentation', 'general'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobMeasurementInputType" AS ENUM ('number', 'text', 'dropdown', 'date'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobChecklistResponseType" AS ENUM ('pass_fail_na', 'yes_no', 'text', 'number'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobScopeResponsibleParty" AS ENUM ('owner', 'yard', 'maker', 'class'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobAttachmentType" AS ENUM ('photo', 'report', 'certificate', 'drawing', 'video', 'manual'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobAttachmentStage" AS ENUM ('before', 'during', 'after', 'final'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobSpareItemType" AS ENUM ('spare', 'consumable', 'tool', 'material'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobQuantityBasis" AS ENUM ('per_job', 'per_unit', 'as_required'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobPricingBasis" AS ENUM ('lump_sum', 'per_unit', 'per_day', 'per_meter'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobUiLayoutType" AS ENUM ('card_tabs', 'wizard', 'single_form', 'split_panels'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobCatalogListType" AS ENUM ('project_types', 'vessel_types', 'departments', 'workshops', 'risk_levels', 'attachment_types', 'job_statuses', 'user_roles'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE "JobWorkflowStatus" AS ENUM ('draft', 'submitted', 'reviewed', 'approved', 'rfq', 'awarded', 'in_progress', 'completed', 'closed', 'cancelled'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

CREATE TABLE IF NOT EXISTS "job_approval_workflows" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "job_dynamic_templates" (
    "id" TEXT NOT NULL,
    "template_id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "master_job_library" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "job_scope_steps" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "job_attachment_requirements" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "job_spare_mappings" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "job_rfq_budget_mappings" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "job_catalog_list_items" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "job_approval_workflows_workflow_id_key" ON "job_approval_workflows"("workflow_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_dynamic_templates_template_id_key" ON "job_dynamic_templates"("template_id");
CREATE UNIQUE INDEX IF NOT EXISTS "master_job_library_job_id_key" ON "master_job_library"("job_id");
CREATE UNIQUE INDEX IF NOT EXISTS "master_job_library_job_library_node_id_key" ON "master_job_library"("job_library_node_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_measurements_measurement_id_key" ON "job_measurements"("measurement_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_checklist_items_checklist_item_id_key" ON "job_checklist_items"("checklist_item_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_scope_steps_scope_step_id_key" ON "job_scope_steps"("scope_step_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_attachment_requirements_attachment_requirement_id_key" ON "job_attachment_requirements"("attachment_requirement_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_spare_mappings_spare_map_id_key" ON "job_spare_mappings"("spare_map_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_rfq_budget_mappings_mapping_id_key" ON "job_rfq_budget_mappings"("mapping_id");
CREATE UNIQUE INDEX IF NOT EXISTS "job_catalog_list_items_list_type_value_key" ON "job_catalog_list_items"("list_type", "value");
