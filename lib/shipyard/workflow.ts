...
export const SHIPYARD_MODULES: ShipyardModuleDef[] = [
  ...
  },
  {
    ...
    description: "Commercial terms and quotation PDF output.",
    dbTables: ["quote_meta", "quote_lines"],
    apiPrefixes: ["/api/shipyard/quotation", "/api/quote"],
    status: "partial",
  },
  {
    id: "awarded_projects",
