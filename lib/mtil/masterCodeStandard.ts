...
export const MASTER_EQUIPMENT_SYSTEM_CODES = {
  ...
  CRK: "Crankshaft & Bearings",
  CYL: "Cylinder Unit",
  TC: "Turbocharger System",
  CON: "Connecting Rod",
  PRD: "Piston Rod & Stuffing Box",
  CAM: "Camshaft & Cam Drive",
  CHN: "Chain Drive & Tightener",
  TRN: "Turning Gear",
  BED: "Bedplate & Frame Box",
  SCV: "Scavenge Air System",
  EXH: "Exhaust Gas System",
  FO: "Fuel Oil System",
  LO: "Lubricating Oil System",
  JCW: "Jacket Cooling Water System",
  PCC: "Piston Cooling System",
  MON: "Monitoring & Sensors",
  SAF: "Safety Devices",
  /** Auxiliary Engine subsystem codes (V3.1). */
  AEB: "Engine Block & Bedplate",
  CYH: "Cylinder Head Assembly",
  LIN: "Cylinder Liner & Piston",
  GOV: "Governor & Speed Control",
  LOC: "Lubricating Oil System (AE)",
  JWC: "Jacket Cooling Water System (AE)",
  ALT: "Alternator & Coupling",
  ELC: "Electrical & Protection",
  MNT: "Mounting & Alignment",
  GEN: "Generator Operation Support",
  CRH: "Crosshead Assembly",
  STA: "Starting Air System",
  LUB: "Lubrication",
  CLG: "Cooling",
  CTL: "Control System",
} as const;
