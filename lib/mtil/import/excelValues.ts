...
const WORKSHOP_MAP: Record<string, JobCatalogWorkshop> = {
  ...
  "engine room / inert gas / nitrogen generator": "machinery",
  "engine room / environmental machinery": "machinery",
  "engine room / hvac ventilation": "machinery",
  "engine room / valves / piping / sea chest / overboard": "machinery",
  "engine room / pipe workshop": "pipe",
  "machinery / valve workshop": "machinery",
  "hull / outboard workshop": "hull",
  "engine room / air handling unit": "machinery",
  "engine room / ventilation": "machinery",
  "engine room / propulsion line": "machinery",
  "engine room / propulsion thruster": "machinery",
  "engine room / stern tube": "machinery",
  "dry dock / propeller": "machinery",
  ...
  "radio / electrical workshop": "electrical",
  "bridge / electrical workshop": "electrical",
  "deck / bridge workshop": "deck",
  "automation workshop": "electrical",
  "cargo workshop": "deck",
  "cargo / tank workshop": "deck",
  "tank gauging / instrumentation workshop": "electrical",
  "instrumentation / electrical workshop": "electrical",
  "cargo / tank instrumentation workshop": "deck",
  "machinery / instrumentation workshop": "machinery",
  "tank workshop": "pipe",
  "deck workshop": "deck",
  deck: "deck",
  ...
  "fire station / deck": "safety",
  "lifeboat station": "safety",
  "engine room / fire fighting systems": "safety",
  "accommodation workshop": "deck",
  "galley / laundry workshop": "deck",
  "hotel / accommodation workshop": "deck",
  "accommodation / galley workshop": "deck",
  "safety / lsa workshop": "safety",
  "safety service": "safety",
  "qa/qc": "qa_qc",
  qa_qc: "qa_qc",
  "survey contractor": "qa_qc",
  "shipyard office": "qa_qc",
};
...
const PARTY_MAP: Record<string, JobScopeResponsibleParty> = {
  ...
  "chief engineer / electrical officer": "owner",
  ...
  "fourth engineer": "owner",
  electrician: "owner",
  "electrician / eto": "owner",
  "eto / electrician": "owner",
  "eto / approved supplier": "owner",
  "safety officer": "owner",
  "safety officer / chief officer": "owner",
  "chief engineer / chief officer": "owner",
  "master / chief officer": "owner",
  "chief officer / chief engineer": "owner",
  "chief officer / approved supplier": "owner",
...
export function mapVesselTypes(value: unknown): string[] {
  ...
  if (/^all\s*\/\s*applicable/i.test(raw)) return ["All Types"];
  if (/all applicable/i.test(raw)) return ["All Types"];
