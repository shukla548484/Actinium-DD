  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      ...
      {open ? (
        <div
          className={cn(
            "absolute top-[calc(100%+4px)] left-0 z-50 w-[18rem] max-w-[calc(100vw-2rem)] overflow-hidden rounded-lg border bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10",
            menuClassName,
          )}
        >
